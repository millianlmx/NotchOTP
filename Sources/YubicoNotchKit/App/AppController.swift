...
public final class AppController: NSObject, NSApplicationDelegate, NSMenuDelegate {
    ...
    private func installStatusItem() {
        ...
        if let button = item.button {
            button.image = NSImage(systemSymbolName: "key.horizontal.fill", accessibilityDescription: "YubicoNotch")
    ...
    public func menuNeedsUpdate(_ menu: NSMenu) {
        ...
        menu.addItem(.separator())
        menu.addItem(item("À propos de YubicoNotch", #selector(showAbout), ""))
        menu.addItem(.separator())
        menu.addItem(item("Quitter YubicoNotch", #selector(quit), "q"))
    }
