...
///
/// The menu bar can ask for a specific pane ("À propos de YubicoNotch"), and the window
        ...
        Form {
            Section {
                ...
                VStack(alignment: .leading, spacing: 4) {
                    Text(
                        "YubicoNotch démarre dans la barre de menus : aucune fenêtre, aucune icône dans le Dock."
                    )
